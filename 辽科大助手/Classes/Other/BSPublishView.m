...
#import "POP.h"
#import "LBComposeViewController.h"
...
{
    return [[[NSBundle mainBundle] loadNibNamed:@"BSPublishView" owner:self options:nil] lastObject];
}
...
/** 点击按钮*/
- (void)clickBtn:(BSVerticalButton *)btn
{
...
//            //添加控制器
            LBComposeViewController *composeVc = [[LBComposeViewController alloc] init];
